...
if active_page == "Corrosion Data":
    ...
    st.caption(
        "Upload a workbook generated above after entering "
        "the source-reported observations. Blank observation "
        "rows are ignored. Normalized and density-derived "
        "values are recalculated by the curator app."
    )
    ...
    uploaded_corrosion_workbook = st.file_uploader(
        ...
        help=(
            "Use the source-first workbook generated by this "
            "curator. Existing observation IDs are used to "
            "update existing records; rows without IDs create "
            "new observations."
        ),
    )
